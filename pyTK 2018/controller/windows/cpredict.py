...
class PredictController():
    ...
    predictIndex = [("offensiveWS","O-Scr"),
                    ...
                    ("avgAutoCubesInSw1","A-C-Sw1"),
                    ("avgAutoCubesInSw2","A-C-Sw2"),
                    ("avgAutoCubesInScl","A-C-Scl"),
                    ("avgAutoCubesInEx","A-C-Ex"),
                    
                    ("teleWS","T-Scr"),

                    ("avgTeleCubesInSw1","T-C-Sw1"),
                    ("avgTeleCubesInSw2","T-C-Sw2"),
                    ("avgTeleCubesInScl","T-C-Scl"),
                    ("avgTeleCubesInEx","T-C-Ex"),
