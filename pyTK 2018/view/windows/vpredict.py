    ...
    def load_team(self, event=None, teamVals=None, index=None):
        ...
        if teamVals[0][0].get() != "0" and teamVals[1][0].get() != "0" and teamVals[2][0].get() != "0":
            ...
            if teamVals == self.rVals:
                self.rOffScore.set("Weighted Offensive Score: " + str(data[0]))
                self.rDefScore.set("Weighted Defensive Score: " + str(data[1]))
            elif teamVals == self.bVals:
                self.bOffScore.set("Weighted Offensive Score: " + str(data[0]))
                self.bDefScore.set("Weighted Defensive Score: " + str(data[1]))

        elif teamVals[0][0].get() == "0" or teamVals[1][0].get() == "0" or teamVals[2][0].get() == "0":
            if teamVals == self.rVals:
                self.rOffScore.set("Weighted Offensive Score: N/A")
                self.rDefScore.set("Weighted Defensive Score: N/A")
            elif teamVals == self.bVals:
                self.bOffScore.set("Weigthed Offensive Score: N/A")
                self.bDefScore.set("Weighted Defensive Score: N/A")
