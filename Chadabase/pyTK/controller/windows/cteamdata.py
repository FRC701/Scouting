...
class TeamDataController():
    ...
    dataLabelVals = [("numMatch","Number of Matches: "),
                     ...
                     ("avgAutoContainersKnockedOver","Average Number of Containers Knocked Over in Auto: "),
                     ("avgAutoContainersFromStep","Average Number of Containers Taken Off the Step in Auto: "),
                     ("avgAutoTotesFromLandfill","Average Number of Totes Taken From the Landfill in Auto: "),
                     ("avgAutoTotesFromStep","Average Number of Totes Taken From the Step in Auto: "),
                     ("avgAutoTotesStacked","Average Number of Non-Auto Totes Stacked in Auto: "),
                     ...
                     ("avgTeleTotesFromStep","Average Number of Totes Taken from the Step: "),
                     ("avgTeleLitterToLandfill","Average Number of Litter Pushed to the Landfill Zone: "),
                     ("avgTeleContainersUpright","Average Number of Containers Made Upright: "),
                     ("avgTeleTotesUpright","Average Number of Totes Made Upright: "),
    ...
    graphVals = [("avgOff","Scores","oScores"),
                 ...
                 ("avgTeleTotesFromStep","Info","teleTotesFromStep"),
                 ("avgTeleLitterToLandfill","Info","teleLitterToLandfill"),
                 ("avgTeleContainersUpright","Info","teleContainersUpright"),
                 ("avgTeleTotesUpright","Info","teleTotesUpright"),
