...
public class VaultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickerMatches = (NumberPicker) findViewById(R.id.pickerMatchVault);
        ...
        SendViaBluetooth = (Button) findViewById(R.id.button_sendDataVault);
        SendViaBluetooth.setEnabled(false);
        DataTransfer = (CheckBox) findViewById(R.id.checkBox_enableDataTransferVault);
    ...
    public void scoutVault(View view){
        ...
        vault.setMatchNum(mCurMatch);
        vault.setAlliance("Red");

        vaultRepo.insert(vault);

        Vault vault2 = new Vault();
        vault2.setCompId(mEvent);
        vault2.setMatchNum(mCurMatch);
        vault2.setAlliance("Blue");

        vaultRepo.insert(vault2);


        Intent intent = new Intent(this, VaultScoutingActivity.class);
        try {
    ...
    public void sendDataViaBluetooth2(View v) {
