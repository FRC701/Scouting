...
public class TeamInfo {
    ...
    public static final String KEY_AvgRobotTopC = "PercentageRocketTopC";
    public static final String KEY_AvgRobotTopH = "PercentageRocketTopH";
    public static final String KEY_AvgRobotMiddleC = "PercentageRocketMiddleC";
    public static final String KEY_AvgRobotMiddleH = "PercentageRocketMiddleH";
    public static final String KEY_AvgRobotBottomC = "PercentageRocketBottomC";
    public static final String KEY_AvgRobotBottomH = "PercentageRocketBottomH";
    public static final String KEY_AvgCargoShipC = "PercentageCargoShipC";
    public static final String KEY_AvgCargoShipH = "PercentageCargoShipH";
    ...
    public void set AvgRocketTopH (double i){avgRocketTopH = i;}
